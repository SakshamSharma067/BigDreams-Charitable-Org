...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      address: "456 Give Street, New York, NY 10002",
      phone: "+1 (555) 234-5678",
      email: "donations@hopeharbor.org",
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-8">
            {contactInfo.map((info, index) => (
              ...
              >
                <h3 className="text-xl font-semibold text-purple-900 mb-4">{info.title}</h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              <h3 className="text-xl font-semibold text-purple-900 mb-4">Follow Us</h3>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-purple-900 mb-2">Subject</label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div>
                  <label className="block text-purple-900 mb-2">Message</label>
                  <textarea
                    name="message"
        ...
        <div className="mt-16">
          <div className="bg-white rounded-2xl p-4 shadow-lg">
            <div className="aspect-w-16 aspect-h-9 rounded-xl overflow-hidden">
              ...
              <div className="w-full h-64 bg-purple-100 rounded-xl flex items-center justify-center text-purple-600">
